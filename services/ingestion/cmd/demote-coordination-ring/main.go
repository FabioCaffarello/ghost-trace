...
func run() error {
	...
	if *actor != "" {
		fmt.Fprintf(os.Stderr,
			"demote-coordination-ring: promotion=%s demotion=%s ingestion=%s cadence_satisfied=%v elapsed=%ds actor=%q\n",
		...
		fmt.Fprintf(os.Stderr,
			"demote-coordination-ring: promotion=%s demotion=%s cadence_satisfied=%v elapsed=%ds\n",
