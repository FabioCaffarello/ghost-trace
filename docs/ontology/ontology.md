...
3. ~~What is the formal definition of `independence` as a measurable quantity?~~ **Resolved per [`decision-log.md` §0133](../charter/decision-log.md): Candidate α (source-count ratio over Cat I provenance roots) adopted under [§2.6 BC2](../charter/constitutional-charter.md#26-evidential-independence-integrity) meta-shape 1 (deterministic-from-pattern).** Formula: `evidential_independence = (count of Cat I roots NOT reachable via any influenced_by edge from a promoted hypothesis) / (total Cat I roots)`. RFC: [`ontology-revision-q3-independence`](../rfcs/draft/ontology-revision-q3-independence.md) (accepted). Evidence: [`q3-independence-evidence.md`](../rfcs/discussion/q3-independence-evidence.md).
4. When does a promoted hypothesis become a candidate for demotion? Lifecycle rule.
5. How does `influence` propagate through derived assertions? Transitive? Decaying? Both? **Decay half resolved at [`§0020`](../charter/decision-log.md) (via §2.5 lifecycle event supersession). Transitivity half opened for discussion as RFC [`ontology-revision-q5-influence-propagation-transitivity`](../rfcs/draft/ontology-revision-q5-influence-propagation-transitivity.md) per [`§0133`](../charter/decision-log.md) cascade-enactment from Q3 resolution;** four candidate transitivity-semantic families enumerated in [`q5-transitivity-evidence.md`](../rfcs/discussion/q5-transitivity-evidence.md) Phase 2.
