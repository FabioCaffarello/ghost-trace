...
**This RFC is a placeholder; Charter dependencies are now discharged.** Substantive content was originally gated on four conditions: §2.4 redaction, §2.6 redaction, [`docs/ontology/ontology.md` §Open Questions](../../ontology/ontology.md) Q3 (formal definition of independence), and Q5 (influence propagation). The Charter-side conditions are now discharged: [Charter §2.4](../../charter/constitutional-charter.md#24-inferential-influence-disclosure) frozen v0.5 at [`§0099`](../../charter/decision-log.md); [Charter §2.6](../../charter/constitutional-charter.md#26-evidential-independence-integrity) frozen v0.6 at [`§0129`](../../charter/decision-log.md). The Ontology-side conditions are partially discharged: Q5's decay half resolved at [`§0020`](../../charter/decision-log.md); Q5 transitivity half pending; Q3 opened at `discussion` status as RFC [`ontology-revision-q3-independence`](./ontology-revision-q3-independence.md) per [`§0132`](../../charter/decision-log.md), with companion discussion-phase scratch [`q3-independence-evidence.md`](../discussion/q3-independence-evidence.md). The Q3 RFC enumerates six candidate measurable-quantity families; selection awaits substantive deliberation. The RFC remains opened so that the §2.5 binding text's forward reference to Layer B retains a canonical referent in the RFC corpus.

## Summary

[`decision-log.md` §0011](../../charter/decision-log.md) (Q4 resolution) adopted the staged-combination form for the demotion-candidacy criterion: Layer A (time-based cadence gate, operational today) AND Layer B (deep criterion on `evidential independence` or declared `influence`). Layer B's specific structural form — which combination of evidence-staleness (Candidate B family from Q4) and/or influence-saturation (Candidate C family from Q4) constitutes the deep criterion — is deferred to this RFC. With §2.4 frozen v0.5 and §2.6 frozen v0.6, the Charter-side structural surfaces are present; the Ontology-side measurable-quantity definition is now under discussion at [`ontology-revision-q3-independence`](./ontology-revision-q3-independence.md) per [`§0132`](../../charter/decision-log.md). Layer B's substantive content emerges once Q3 resolves and Q5 transitivity is assessed.
