...
# --- layout ----------------------------------------------------------
GO_MODULES  := services/collector services/archive services/decision-engine services/demo-web libs/archive libs/canonical libs/decision libs/eventstream libs/feature libs/genproto libs/id libs/middleware libs/policy libs/snapshot libs/substrate libs/tenant libs/wire
